#!/bin/bash
# sync_to_nas.sh - Sync Not2Pix builds to NAS with interactive progress and remote cleanup
...
# Print Header
echo -e "${BOLD}${PURPLE:-$CYAN}==================================================${NC}"
echo -e "${BOLD}${PURPLE:-$CYAN}🎨  Not2Pix NAS Sync & Cleanup Utility${NC}"
echo -e "${BOLD}${PURPLE:-$CYAN}==================================================${NC}"
...
tasks=(
    "dir|out/|$NAS_DIR/out_not2pix/|out"
)
